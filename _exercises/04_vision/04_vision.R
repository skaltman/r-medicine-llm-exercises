...
chat$chat(
  ...
  content_image_file(
    "~/r-medicine-llm-exercises/_exercises/04_vision/health-expenditure-preventive.png"
  )
)
...
chat2$chat(
  ...
  content_image_file(
    "~/r-medicine-llm-exercises/_exercises/04_vision/health-expenditure-curative-comparison.png"
  )
)
